...
The public analysis Colab executes an analysis reconstruction from the recorded study snapshot. A separate [end-to-end rerun Colab](../notebooks/end-to-end-rerun.ipynb) installs the pinned chemistry environment, runs receptor preparation and validation-gated docking, and writes a machine-readable receipt. Its bounded Linux execution completed successfully on GitHub Actions (run [29725376243](https://github.com/Terpedia/terpedia-research-papers/actions/runs/29725376243)): CYP19A1 redocking passed all three seeds with median RMSD 0.6486 A, and 24 candidate docking runs were recorded. The full five-target/high-exhaustiveness panel remains an explicit opt-in mode and is not represented by this bounded receipt. No source figures were supplied in the reference materials available to this study, so no figure is claimed as reproduced.
...
The bounded Linux smoke execution receipt is available as [execution-receipt-smoke.json](execution-receipt-smoke.json). The clean-session end-to-end notebook and receipt are preserved in the [GitHub Actions artifact](https://github.com/Terpedia/terpedia-research-papers/actions/runs/29725376243) (executed notebook SHA-256 `9a1dbbfd35ee19d695d4859d4196975676cdf15fc9de63a86fcdcd081de07ff7`; consolidated receipt SHA-256 `2e7b7b198f644e8cdf81126f062da62c0b95ee371e545d795ff9affacd7a813e`). A completed asynchronous HQ receipt for CB2 is available as [execution-receipt-hq-cb2.json](execution-receipt-hq-cb2.json); CB2 passed the 3-of-5 redocking gate and produced a ten-member Vina/Vinardo shortlist with seed dispersion. The consolidated [HQ study receipt](execution-receipt-hq-study.json) records all five target outcomes: CB2 and CYP19A1 passed, AR failed the validation gate, and ERbeta/HSD11B1 stopped during preparation. The bounded rerun is complete and reproducible; the full panel remains explicitly identified as future work rather than implied by the bounded receipt.
